...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        container.image = [UIImage resizedImageWithName:@"popover_background"];
...
{
    return [[self alloc] initWithContentVc:contentVc];
}
...
- (void)showInRect:(CGRect)rect
{
    ...
    if ([self.delegate respondsToSelector:@selector(popMenuDidShow:)]) {
        [self.delegate popMenuDidShow:self];
    }
}
